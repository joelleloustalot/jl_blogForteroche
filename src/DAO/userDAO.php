...
class UserDAO extends DAO
{
    ...
    {
        $sql = 'SELECT user.id, user.pseudo, user.creation_date, role.name FROM user INNER JOIN role ON user.role_id = role.id ORDER BY user.id DESC';
    ...
    {
        $this->checkUser($post);
        $sql = 'INSERT INTO user (pseudo, password, creation_date,role_id) VALUES (?, ?, NOW(), ?)';
